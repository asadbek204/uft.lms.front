...
function A() {
    ...
    return (
        <div className="item a p-4 w-1/3 flex flex-col shadow-md rounded-2xl bg-white dark:bg-gray-800"
            ...
            <div className="text-black text-xl md:text-5xl dark:text-white">{formattedDate}</div>
        </div>
    )
}
...
function D() {
    ...
    return (
        <div data-swapy-item="d" className="item d p-4 w-1/3 flex flex-col shadow-md rounded-2xl bg-white dark:bg-gray-800">
            ...
            <div className="space-y-1">
                <div className="gap-2 flex items-end">
                    <h1 className="text-xl md:text-5xl text-black dark:text-white">7</h1>
                    {/*<span className="leading-none text-xs md:text-4xl text-black dark:text-white">{contents.students}</span>*/}
                </div>
            </div>
        </div>
    )
    ...
    return (
        <div className="header w-full  mt-12 md:mt-0">
            <div className="mt-5 ms-5">
                <h1 className="2xl:text-4xl md:text-3xl text-xl text-customText font-bold ">
                    {contents.title1}
                </h1>
                <h1 className="mt-2 md:text-3xl mb-4 text-xl font-bold dark:text-white">{contents.title2} {capitalize(student.first_name)} {capitalize(student.last_name)}</h1>
            </div>

            <div className="w-full 2xl:h-[87%] h-[65%] overflow-y-auto">

            <div className="manager flex justify-between w-11/12 xl:w-8/12 gap-5 mt-10 mx-auto">
