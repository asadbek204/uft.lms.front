...
const contentsMap = new Map<Langs, TGroupsComponentContent>([
    [Langs.UZ, { title: "Sizning davomatingiz",attandance: "Bugungi dars", data: "Sana", status: "Status" }],
    [Langs.RU, { title: "Ваша посещаемость", attandance: "Сегодняшний урок", data: "Дата", status: "Статус" }],
    [Langs.EN, { title: "Your attendance", attandance: "Today's Lesson", data: "Date", status: "Status" }],
]);
