...
const Group: React.FC = () => {
    ...
    return (
        <div>
            <div className="header  mt-14 md:mt-0">
            ...
            <div ref={scrollRef}
                 ...
                 className="mx-auto border-x-slate-600  border-collapse 2xl:h-[88%]  h-[460px] overflow-y-auto w-11/12">
                <div className="courses shadow-md flex flex-col gap-7 justify-center content-center">
                    <table
                        className="2xl:w-full text-center font-normal mx-auto xl:text-2xl sm:text-md table-fixed border-collapse border border-slate-600 dark:text-white">
                        <thead>
                        <tr>
                        ...
                        {students.map((student, index) => {
                            ...
                            return (
                                <tr key={student.id}>
                                    ...
                                    <td className="border border-slate-600 font-sm text-base 2xl:text-2xl py-1 duration-300 ease-in-out hover:text-blue-400">
                                        <Link to={`/teachers/group/student/${student.id}`}>
