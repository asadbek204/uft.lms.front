...
function DebtorsPageUsers() {
  ...
  const [selectedMoveGroup, setSelectedMoveGroup] = useState<number | null>(
    null
  );
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        const userData = {
          ...response.data.user,
          price: response.data.document[0].price,
        };
    ...
    (async () => {
      try {
        const list = await client.get(
          `education/group/list/?needed_role=${role}`
        );
    ...
    <div className="w-full overflow-y-hidden mt-12 md:mt-0">
                ...
                <div className="relative ml-2">
                  ...
                  {isMoveOpen && (
                    <div
                      ...
                      className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded shadow-lg z-10"
                    >
                      <ul
                      ...
                      >
                        {groups.map((g) => (
                          <li key={g.id}>
                            <button
                              className={`w-full text-left px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 text-black dark:text-white ${
                                selectedMoveGroup === g.id
                      ...
                      <div className="p-2 border-t border-gray-200 dark:border-gray-700">
                        <button
                          ...
                          onClick={async (e) => {
                            ...
                            try {
                              await client.patch(`students/update/${id}/`, {
                                groups: selectedMoveGroup,
                              });
      ...
      {loading ? (
        ...
        <div className="p-6  w-full mx-auto 2xl:h-[88%] h-[80%] overflow-y-scroll gap-4 ">
          ...
          <form
            ref={formRef}
            className="md:flex justify-around  2xl:h-[88%] h-[78%] overflow-y-auto"
          >
            <div className="">
              <div className="">
                    ...
                    >
                      ...
                      <label className="block text-gray-700 dark:text-gray-300">
                        ...
                        <select
                          ...
                          className="block h-10 px-4 w-full mt-1 border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-300"
                        >
                          <option value="">{contents.choose_gender}</option>
