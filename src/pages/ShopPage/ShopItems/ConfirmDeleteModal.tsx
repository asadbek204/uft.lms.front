...
const contentsMap = new Map<Langs, TProductComponentContent>([
    [Langs.UZ, {
        toast1: "Mahsulot muvaffaqiyatli oʻchirildi",
        toast2: "Mahsulotni o‘chirib bo‘lmadi",
        toast3: "Mahsulot bo'sh emas!",
        title: "Mahsulotni o‘chirishni tasdiqlang",
        description: "O'chirish uchun 2 martta bosing",
        button1: "Bekor qilish",
        button2: "Tasdiqlash"
    }],
    [Langs.RU, {
        toast1: "Продукт успешно удален",
        toast2: "Не удалось удалить продукт",
        toast3: "Продукт не пустой!",
        title: "Подтвердить удаление продукта",
        description: "Дважды щелкните, чтобы удалить",
        button1: "Отмена",
        button2: "Подтверждать"
    }],
    [Langs.EN, {
        toast1: "Product deleted successfully",
        toast2: "Failed to delete product",
        toast3: "The product is not empty!",
